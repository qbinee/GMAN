...
parser.add_argument('--traffic_file', default='/Users/igyubin/school/GMAN/data/metr-la.h5', help='traffic file')  # default를 절대 경로로 수정해주세요
parser.add_argument('--SE_file', default='/Users/igyubin/school/GMAN/METR/data/SE(METR).txt', help='spatial emebdding file')  # default를 절대 경로로 수정해주세요
parser.add_argument('--model_file', default='data/Adj(METR).txt', help='pre-trained model')  # 존재하지 않습니다 원래 값: data/GMAN(METR)
parser.add_argument('--log_file', default='data/log(METR)', help='log file')  # METR/data 아래에 logfile이 자동으로 생성됩니다.
